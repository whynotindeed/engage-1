...
class UpgradeModel extends BaseModel implements DatabaseAwareInterface
{
	 ...
	 * @var   string
	 */
	private const PACKAGE_NAME = 'pkg_engage';
	...
	private const REMOVE_FROM_ALL_VERSIONS = [
		'files'   => [
			/**
			 * Old backend Blade templates.
			 *
			 * Even though the old template folders were MixedCase and the new ones are lowercase we can't delete the
			 * whole folder indiscriminately. On case–insensitive filesystems (all Windows FS, most macOS FS) this would
			 * delete the similar named all lowercase folders, breaking the component. I am deleting the old files
			 * instead which may leave behind empty MixedCase folders. I say “may” because Joomla is supposed to make a
			 * list of currently installed folders and folders included in the package, removing the difference between
			 * the two. On a case–sensitive filesystem the clean up will work. On a case insensitive filesystem the
			 * MixedCase folders will be left behind and I'll be cleaning up their contents.
			 */
			JPATH_ADMINISTRATOR . '/components/com_engage/tmpl/Comments/default.blade.php',
			JPATH_ADMINISTRATOR . '/components/com_engage/tmpl/Comments/form.blade.php',
			JPATH_ADMINISTRATOR . '/components/com_engage/tmpl/Common/ShowUser.blade.php',
			JPATH_ADMINISTRATOR . '/components/com_engage/tmpl/Common/README.php',
			JPATH_ADMINISTRATOR . '/components/com_engage/tmpl/EmailTemplates/default.blade.php',
			JPATH_ADMINISTRATOR . '/components/com_engage/tmpl/EmailTemplates/form.blade.php',
			// Old language files which interfere with com_mails
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.com_engage.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.com_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.com_engage.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.com_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.com_engage.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.com_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.com_engage.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.com_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/fr-FR/fr-FR.com_engage.ini',
			JPATH_ADMINISTRATOR . '/language/fr-FR/fr-FR.com_engage.sys.ini',
			JPATH_SITE . '/language/de-DE/de-DE.com_engage.ini',
			JPATH_SITE . '/language/de-DE/de-DE.com_engage.sys.ini',
			JPATH_SITE . '/language/el-GR/el-GR.com_engage.ini',
			JPATH_SITE . '/language/el-GR/el-GR.com_engage.sys.ini',
			JPATH_SITE . '/language/en-GB/en-GB.com_engage.ini',
			JPATH_SITE . '/language/en-GB/en-GB.com_engage.sys.ini',
			JPATH_SITE . '/language/es-ES/es-ES.com_engage.ini',
			JPATH_SITE . '/language/es-ES/es-ES.com_engage.sys.ini',
			JPATH_SITE . '/language/fr-FR/fr-FR.com_engage.ini',
			JPATH_SITE . '/language/fr-FR/fr-FR.com_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.plg_actionlog_engage.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.plg_actionlog_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.plg_actionlog_engage.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.plg_actionlog_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.plg_actionlog_engage.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.plg_actionlog_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.plg_actionlog_engage.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.plg_actionlog_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/fr-FR/fr-FR.plg_actionlog_engage.ini',
			JPATH_ADMINISTRATOR . '/language/fr-FR/fr-FR.plg_actionlog_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.plg_content_engage.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.plg_content_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.plg_content_engage.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.plg_content_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.plg_content_engage.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.plg_content_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.plg_content_engage.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.plg_content_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/fr-FR/fr-FR.plg_content_engage.ini',
			JPATH_ADMINISTRATOR . '/language/fr-FR/fr-FR.plg_content_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.plg_datacompliance_engage.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.plg_datacompliance_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.plg_datacompliance_engage.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.plg_datacompliance_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.plg_datacompliance_engage.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.plg_datacompliance_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.plg_datacompliance_engage.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.plg_datacompliance_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/fr-FR/fr-FR.plg_datacompliance_engage.ini',
			JPATH_ADMINISTRATOR . '/language/fr-FR/fr-FR.plg_datacompliance_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.plg_engage_akismet.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.plg_engage_akismet.sys.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.plg_engage_akismet.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.plg_engage_akismet.sys.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.plg_engage_akismet.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.plg_engage_akismet.sys.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.plg_engage_akismet.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.plg_engage_akismet.sys.ini',
			JPATH_ADMINISTRATOR . '/language/fr-FR/fr-FR.plg_engage_akismet.ini',
			JPATH_ADMINISTRATOR . '/language/fr-FR/fr-FR.plg_engage_akismet.sys.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.plg_engage_email.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.plg_engage_email.sys.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.plg_engage_email.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.plg_engage_email.sys.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.plg_engage_email.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.plg_engage_email.sys.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.plg_engage_email.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.plg_engage_email.sys.ini',
			JPATH_ADMINISTRATOR . '/language/fr-FR/fr-FR.plg_engage_email.ini',
			JPATH_ADMINISTRATOR . '/language/fr-FR/fr-FR.plg_engage_email.sys.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.plg_engage_gravatar.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.plg_engage_gravatar.sys.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.plg_engage_gravatar.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.plg_engage_gravatar.sys.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.plg_engage_gravatar.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.plg_engage_gravatar.sys.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.plg_engage_gravatar.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.plg_engage_gravatar.sys.ini',
			JPATH_ADMINISTRATOR . '/language/fr-FR/fr-FR.plg_engage_gravatar.ini',
			JPATH_ADMINISTRATOR . '/language/fr-FR/fr-FR.plg_engage_gravatar.sys.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.plg_privacy_engage.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.plg_privacy_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.plg_privacy_engage.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.plg_privacy_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.plg_privacy_engage.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.plg_privacy_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.plg_privacy_engage.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.plg_privacy_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/fr-FR/fr-FR.plg_privacy_engage.ini',
			JPATH_ADMINISTRATOR . '/language/fr-FR/fr-FR.plg_privacy_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.plg_system_engagecache.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.plg_system_engagecache.sys.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.plg_system_engagecache.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.plg_system_engagecache.sys.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.plg_system_engagecache.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.plg_system_engagecache.sys.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.plg_system_engagecache.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.plg_system_engagecache.sys.ini',
			JPATH_ADMINISTRATOR . '/language/fr-FR/fr-FR.plg_system_engagecache.ini',
			JPATH_ADMINISTRATOR . '/language/fr-FR/fr-FR.plg_system_engagecache.sys.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.plg_user_engage.ini',
			JPATH_ADMINISTRATOR . '/language/de-DE/de-DE.plg_user_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.plg_user_engage.ini',
			JPATH_ADMINISTRATOR . '/language/el-GR/el-GR.plg_user_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.plg_user_engage.ini',
			JPATH_ADMINISTRATOR . '/language/en-GB/en-GB.plg_user_engage.sys.ini',
			JPATH_ADMINISTRATOR . '/language/es-ES/es-ES.plg_user_engage.ini',
		...
		'folders' => [
			...
			JPATH_ADMINISTRATOR . '/tmpl/ErrorPages',

			// Old backend MVC
			JPATH_ADMINISTRATOR . '/components/com_engage/Controller',
			JPATH_ADMINISTRATOR . '/components/com_engage/Dispatcher',
			...
			// Old frontend MVC
			JPATH_SITE . '/components/com_engage/Controller',
			JPATH_SITE . '/components/com_engage/Dispatcher',
